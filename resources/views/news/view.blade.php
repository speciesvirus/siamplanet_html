                ...
                <div class="social-sharing-bot">
                    <ul class="social">
                        <li class="social-twitter">
                            <a href="http://twitter.com" title="Twitter" target="_blank"><i
                                        class="fa fa-twitter icon-2x" aria-hidden="true">&nbsp;</i></a>
                        </li>
                        <li class="social-facebook">
                            <a href="http://www.facebook.com" title="Facebook" target="_blank"><i
                                        class="fa fa-facebook icon-2x">&nbsp;</i></a></li>
                        <li class="social-pinterest">
                            <a href="http://www.pinterest.com" title="Pinterest" target="_blank"><i
                                        class="fa fa-pinterest-p icon-2x">&nbsp;</i>
                            </a>
                        </li>
                        <li class="social-google">
                            <a href="http://www.youtube.com" title="Google+" target="_blank"><i
                                        class="fa fa-google-plus icon-2x">&nbsp;</i></a>
                        </li>
                        <li class="social-linkedin">
                            <a href="http://www.pinterest.com" title="Pinterest" target="_blank"><i
                                        class="fa fa-linkedin icon-2x">&nbsp;</i>
                            </a>
                        </li>
                    </ul>
        ...
        <div id="mvp_tagrow_widget-2" class="home-widget left relative mvp_tagrow_widget">
            <div class="row-widget-wrap left relative">
                <ul class="row-widget-list">
                    <li>
                        <a href="http://www.mvpthemes.com/flexmag/yes-there-are-now-jeans-that-can-charge-your-phone/"
                           rel="bookmark">
                            <div class="row-widget-img left relative">
                                <img width="300" height="180"
                                     src="http://www.mvpthemes.com/flexmag/wp-content/uploads/2015/08/woman-jeans-300x180.jpg"
                    ...
                    <li>
                        <a href="http://www.mvpthemes.com/flexmag/5-straight-outta-compton-cameos-that-will-make-you-do-a-double-take/"
                           rel="bookmark">
                            <div class="row-widget-img left relative">
                                <img width="300" height="180"
                                     src="http://www.mvpthemes.com/flexmag/wp-content/uploads/2015/08/music-dj-300x180.jpg"
                                     class="reg-img wp-post-image" alt="">
                                <div class="feat-info-wrap">
                                    <div class="feat-info-views">
                    ...
                    <li>
                        <a href="http://www.mvpthemes.com/flexmag/googles-alphabet-rollout-could-still-be-a-qwikster-like-farce/"
                           rel="bookmark">
                            <div class="row-widget-img left relative">
                                <img width="300" height="180"
                                     src="http://www.mvpthemes.com/flexmag/wp-content/uploads/2015/08/interview-300x180.jpg"
                                     class="reg-img wp-post-image" alt="">
                                <div class="feat-info-wrap">
                                    <div class="feat-info-views">
