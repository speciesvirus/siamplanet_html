...
//            console.log('sss', model.name);
            ...
            var $html = '<div class="fc-d" data-fc="'+ model.id +'"><label class="col-xs-6 col-sm-3 l-m-3 control-label">'+ model.name +'</label>'+
        ...
        $(function () {
            ...
            $('#add-block-unit').click(function () {
                ...
                var $html = '<div class="block-unit">'+
                    ...
                    '<div class="form-group">'+
                        '<label class="col-xs-6 col-sm-3 l-m-3 control-label required">ขนาดพื้นที่</label>'+
                        '<div class="col-md-5">'+
                    ...
                    '<div class="form-group">'+
                        '<label class="col-xs-6 col-sm-3 l-m-3 control-label required">ราคา</label>'+
                        '<div class="col-md-5">'+
                    ...
                    '<div class="form-group m-no-margin">'+
                        '<label class="col-xs-6 col-sm-3 l-m-3 control-label required">ภาพ</label>'+
                        '<div class="col-md-5">'+
                            '<div class="fc-input">'+
                    ...
                    '<div class="form-group m-no-margin not-validate">'+
                        '<label class="col-xs-6 col-sm-3 l-m-3 control-label">&nbsp</label>'+
                        '<div class="col-md-5">'+
                            '<div class="fc-input">'+
                                '<input class="form-control form-input form-style-base input-u-f" type="file">'+
                                '<input class="form-control form-input form-style-fake" placeholder="Choose your File" readonly="" type="text">'+
                    ...
                    '<div class="form-group form-group-last not-validate">'+
                        '<label class="col-xs-6 col-sm-3 l-m-3 control-label">&nbsp</label>'+
                        '<div class="col-md-5">'+
                            '<div class="fc-input">'+
                                '<input class="form-control form-input form-style-base input-u-f" type="file">'+
        ...
        <div class="section">
            ...
            <div class="form-horizontal">
                ...
                <div class="form-group {{ $errors->has('size') ? 'has-error' : '' }}">
                    <label class="col-xs-6 col-sm-3 l-m-3 control-label required" for="size">ขนาดพื้นที่เริ่มต้น</label>
                    <div class="col-md-5">
                        <div class="input-group">
                ...
                <div class="form-group {{ $errors->has('price') ? 'has-error' : '' }}">
                    <label class="col-xs-6 col-sm-3 l-m-3 control-label required" for="price">ราคาเริ่มต้น</label>
                    <div class="col-md-5">
                            <div class="input-group">
            ...
            <div class="form-horizontal">
                    ...
                    <div class="form-group form-group-last">
                        <label class="col-xs-6 col-sm-3 l-m-3 control-label"></label>
                        <div class="col-md-5">
            ...
            <div class="form-horizontal">
                ...
                <div class="form-horizontal form-group-last">
                    ...
                    <!-- Text input -->
                    <div class="form-group">
                        <label class="col-xs-6 col-sm-3 l-m-3 control-label" for="status"></label>
                        <div class="col-md-5">
